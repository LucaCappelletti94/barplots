...
def plot_bar_labels(
    ...
    for level in reversed(range(max(levels-2, 0), levels)):
        ...
        if minor_rotation == "auto":
            if (
                minor and
                width * 6 / max_characters_number_in_labels < len(set(labels)) and
                vertical
            ):
        ...
        if major_rotation == "auto":
            if (
                ...
                not minor and
                len(set(labels)) >= width * 10 / max_characters_number_in_labels and
                vertical
            ):
                adapted_major_rotation = 90
            else:
        ...
        if vertical:
            ...
            if minor:
                ...
                if adapted_minor_rotation > 80:
                    length = 5.5 * max_characters_number_in_labels
                else:
                    length = 20
